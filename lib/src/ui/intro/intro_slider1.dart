  ...
  void initState() {
    ...
    slides.add(
      new Slide(
        ...
        description:
            "Kaufen Sie alle wichtigen Dinge bequem auf Knopfdruck ein und genießen Sie eine schnelle Lieferung",
        //description: "Best quality products at affordable rates",
    ...
    slides.add(
      new Slide(
        title: "Erhalten Sie immer die besten Angebote",
        //title: "Always the best deals",
        ...
        styleTitle: TextStyle(
            ...
            fontWeight: FontWeight.bold,
            fontFamily: 'RobotoMono'),
        description: "Holen Sie sich tolle Angebote, Rabatte und Deals",
        //description: "Get great offers, discounts and deals",
